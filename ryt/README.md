...
bot findings to OpenCode. The model must fetch every page and submit structured file
...
A disposition proves input delivery and a completed model response, not that an AI
